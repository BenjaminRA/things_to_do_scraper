...
if __name__ == '__main__':
    ...
    if confirm.lower() == 'y':
        ...
        print('Deleting paises from database...')
        client.paises.delete_many({})

        print('Deleting departamentos from database...')
        client.departamentos.delete_many({})

        print('Deleting ciudades from database...')
        client.ciudades.delete_many({})

        print('Deleting atracciones from database...')
